...
class AdminCvListScreen extends StatefulWidget {

  @override
  _AdminCvListScreenState createState() => _AdminCvListScreenState();
}

class _AdminCvListScreenState extends State<AdminCvListScreen> {
  var userData;
        ...
        children: [
          ...
          if(userData != null) Expanded(child: ListView.separated(
            ...
            itemBuilder: (context, index) {
              return InkWell(
                onTap: () {
                  Get.to(() => AdminCvsScreen(userData[index]));
                },
                child: Container(
  ...
  getExamData() async {
    var data = await LoginRepository.getAllCvData(context: context,);
    setState(() {
      userData = data['data'];
      print(userData);
    });
