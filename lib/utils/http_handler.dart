...
// import 'package:home_dine/src/config/app_constatnt.dart';
// import 'package:home_dine/src/config/default_data.dart';
...
class HttpHandler {
  ...
  static Future<Map<String, dynamic>> postHttpMethod({@required String url,data, String token}) async {
    if (token != null) {
  ...
  static Future<Map<String, dynamic>> putHttpMethod({@required String url, Map<String, dynamic> data, String token}) async {
    if (token != null) {
      //var header = await _getHeaders();
  ...
  static Future<Map<String, dynamic>> getHttpMethod({@required String url, String token}) async {
    if (token != null) {
      var header = await _getHeaders();
  ...
  static Future<Map<String, dynamic>> deleteHttpMethod({@required String url, String token}) async {
    if (token != null) {
      //var header = await _getHeaders();
  ...
  //post method
  static Future<Map<String, dynamic>> postDioHttpMethod({@required String url, Map<String, dynamic> data}) async {
    var header = await _getHeaders();
    print("Post URL -- '$endPointUrl$url'");
    print("Post Data -- '$data'");
    http.Response response = await http.post(
